...
public class HelloServlet extends HttpServlet {
   // 중요 : 서블릿 실행 하는 방법은 web.xml에 매핑 시킨 주소를 브라라우저 주소창에 입력 한다.
   ...
   protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
      ...
      // 브라우저에 출력 되는 방식 
      // Request 객체에는 요청 정보(파라미터, session, uri 등)가 저장된다.
      // Response 객체에는 브라우저에 처리하는 정보(forward, redirect 등)가 저장 된다.
      
      // 브라우저에 출력(printWirter)
      ...
      out.println("  </head>");
      out.println("  <body>");
      out.println("    <p><a href=\"http://www.naver.com\">Hello world</a></p>");
      out.println("  </body>");
      out.println("</html>");
