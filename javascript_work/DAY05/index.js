...
app.get("/", (req, res) => {
  ...
  // res.write("<ul><li><a href='/html/js_day05ex01_1.html'>ex01_1</a></li>");
...
app.get("/home", (req, res) => {
  ...
  // req.app.render(ejs파일명, 데이터객체(속성 : 내용), 콜백함수);
  // 콜백 함수의 첫번째는 err객체
  var testArr = [
...
server.listen(3000, () => {
  console.log("서버실행중 : localhost:3000");
});
// nodejs를 설치하면 npm이 같이 설치 된다.
// npm : 패키지 매니저
// 자동으로 모듈을 설치하고 제거하고 관리한다.
// npm install --save 모듈
// npm i -S 모듈
// --save : 현재 프로젝트에 저장. -S
// --save-dev : 개발 환경에서만 사용. -D
// -g : 글로벌 환경에 저장
// npm uninstall -g 모듈
// npm list -g --depth=0
